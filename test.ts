function objectToQueryParams(originObject: any, originPrefix = ''): string {
...
const object = {
  privileges: [
    { condition: true, Permission: {condition: true} }
  ]
};

const result = objectToQueryParams(object);
console.log("🚀 ~ file: test.ts:52 ~ result:", result)
