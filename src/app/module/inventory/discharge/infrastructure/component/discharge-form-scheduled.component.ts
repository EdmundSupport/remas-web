...
@Component({
    selector: 'app-discharge-form-scheduled',
    templateUrl: '../page/discharge-form-scheduled.page.html',
    styleUrls: ['../style/discharge-form-scheduled.style.scss'],
})
export class DischargeFormScheduledComponent {
    @Output('onDelete') onDelete = new EventEmitter();
    @Output('onChange') onChange = new EventEmitter();
    @Output('onLoad') onLoad = new EventEmitter();
    @Input('detail') detail: Partial<DischargeDetailScheduledInterface> = {
        amount: '',
        productUuid: '',
        measureUnitUuid: '',
        dischargeDetails: []
    ...
    onAddDetail() {
        if (this.detail && this.detail.dischargeDetails) this.detail.dischargeDetails.push({} as any);
        else this.detail.dischargeDetails = [{} as any];

    }

    onChangeDetail(index: number, detail: DischargeDetailInterface) {
        if (this.detail && this.detail.dischargeDetails && this.detail.dischargeDetails[index]) {
            this.detail.dischargeDetails[index] = detail;
