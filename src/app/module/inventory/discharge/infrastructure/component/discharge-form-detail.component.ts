...
@Component({
    selector: 'app-discharge-form-detail',
    templateUrl: '../page/discharge-form-detail.page.html',
    styleUrls: ['../style/discharge-form-detail.style.scss'],
})
export class DischargeFormDetailComponent {
    @Output('onDelete') onDelete = new EventEmitter();
    @Output('onChange') onChange = new EventEmitter();
    @Output('onLoad') onLoad = new EventEmitter();
    @Input('detail') detail!: DischargeDetailInterface;
